...
public class HttpClientDemo {
    ...
    private final static Logger logger = LoggerFactory.getLogger(HttpClientDemo.class);
    ...
    private static CookieStore firstLoginGetCookie(CloseableHttpClient httpclient) throws Exception{
        ...
        // JSESSIONID
        String setCookie = execute.getFirstHeader("Set-Cookie")
                .getValue();
    ...
    private static void customeHttpClient() throws IOException {
    ...
    private static HttpClientConnectionManager setConnManager(Registry<ConnectionSocketFactory> socketFactoryRegistry,
        ...
        // Create socket configuration tcp设置
    ...
    private static DnsResolver setDnsResolver(String myHost){
     ...
     * @return
     */
    private static HttpConnectionFactory<HttpRoute, ManagedHttpClientConnection> setConnFactory(){
     ...
     * @return
     */
    private Registry<ConnectionSocketFactory> setSocketConfig(){
    ...
    private static void simpleGet() throws IOException {
        ...
        String resStr = httpclient.execute(httpGet, response -> {
