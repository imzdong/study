...
import org.imzdong.ticket.dto.LoginResult;
...
public class Login {
    ...
    private boolean logDevice(String logDeviceUrl){
        log.info("初始化登录：1.2、设置cookie（RAIL_EXPIRATION+RAIL_DEVICEID）");
