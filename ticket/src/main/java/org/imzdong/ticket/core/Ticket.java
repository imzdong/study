...
import org.imzdong.ticket.dto.TicketInfoDTO;
...
public class Ticket {
    ...
    public static JSONObject thirdConfirmSubmitToken() throws Exception{
        ...
        if(globalRepeatSubmitToken!=null&&ticketInfoForPassengerForm!=null
            ...
            log.info("globalRepeatSubmitToken：{}",globalRepeatSubmitToken);
            log.info("ticketInfoForPassengerForm：{}",ticketInfoForPassengerForm);
